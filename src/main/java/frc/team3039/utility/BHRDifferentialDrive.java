...
public class BHRDifferentialDrive extends RobotDriveBase {
  ...
  private Sendable mSendableParent;
  ...
  public BHRDifferentialDrive(SpeedController leftMotor, SpeedController rightMotor) {
    ...
    SendableRegistry.addChild(mSendableParent, m_leftMotor);
    SendableRegistry.addChild(mSendableParent, m_rightMotor);
    instances++;
    SendableRegistry.setName(mSendableParent,"DifferentialDrive", instances);
  }
