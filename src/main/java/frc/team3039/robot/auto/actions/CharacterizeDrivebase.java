...
public class CharacterizeDrivebase extends AutoRoutineBase {
  ...
  public CharacterizeDrivebase(boolean isHighGear, boolean isReversed, boolean isTurning) {
  ...
  protected void routine() throws AutoModeEndedException {
    ...
    runAction(new SeriesAction(new CollectVelocityData(velocityData, isHighGear, reversed, turn)));
    runAction(new WaitAction(10));
    runAction(new SeriesAction(new CollectAccelerationData(accelerationData, isHighGear, reversed, turn)));
    runAction(new WaitAction(10));
